...
OFFSET_TO_GOAL = 25 # to trick the path planner and get a proper orientation at the pruning point, was 15, 20
...
MAX_TARGET_SPEED = 0.3#10.0 / 3.6  # [m/s] target speed, was 0.5
MIN_TARGET_SPEED = 0.15# 0.210.0 / 3.6  # [m/s] target speed, was 0.1
N_IND_SEARCH = 10  # Search index number
T_RAMP_UP = .5 #0.5, was 1
T_RAMP_DOWN = 5. #, was 5.0
DIST_TO_GOAL_STOP = 0.1  # abhi 0.15 this parameter controls the stoping distance to one pruning location, was 0.2
